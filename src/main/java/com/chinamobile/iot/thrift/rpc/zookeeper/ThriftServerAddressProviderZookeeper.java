package com.chinamobile.iot.thrift.rpc.zookeeper;
...
public class ThriftServerAddressProviderZookeeper
    ...
    private void buildPathChildrenCache(final CuratorFramework client,
    ...
    @Override
    public boolean existServer(InetSocketAddress inetSocketAddress) {
        return container.contains(inetSocketAddress);
    }
