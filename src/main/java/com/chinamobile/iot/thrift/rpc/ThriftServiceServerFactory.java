...
import com.chinamobile.iot.thrift.rpc.zookeeper.ThriftServerAddressRegister;
import com.chinamobile.iot.thrift.rpc.zookeeper.ThriftServerIpLocalNetworkResolve;
import com.chinamobile.iot.thrift.rpc.zookeeper.ThriftServerIpResolve;
...
public class ThriftServiceServerFactory implements InitializingBean, Closeable {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        if (thriftServerAddressRegister != null) {
            thriftServerAddressRegister.register(serviceName, version,
                    hostname);
        }
    ...
    class ServerThread extends Thread {
        ...
        ServerThread(TProcessor processor, int port) throws Exception {
            ...
            tArgs.protocolFactory(new TCompactProtocol.Factory()); // new
